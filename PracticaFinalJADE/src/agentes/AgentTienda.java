...
import comportamientos.CyclicBehaviourTienda;
import jade.content.lang.sl.SLCodec; //Aniadido para poder hacer la linea 26
import jade.core.Agent;
import jade.domain.DFService; //Aniadido para poder hacer la linea 34
import jade.domain.FIPAException;
import jade.domain.FIPAAgentManagement.DFAgentDescription;
import jade.domain.FIPAAgentManagement.ServiceDescription;

public class AgentTienda extends Agent {
	...
	public void setup() 
	{
		...
		addBehaviour(new CyclicBehaviourTienda());
	}
